...
class Player(GameObject):
    ...
    def on_draw(self):
        ...
        # hair
        Draw.line(312, 20, 320, 50)
        Draw.line(325, 20, 320, 50)
        Draw.line(325, 20, 330, 50)
        Draw.line(338, 20, 330, 50)
        Draw.line(338, 20, 345, 50)
        Draw.line(350, 20, 345, 50)
        Draw.line(350, 20, 355, 50)
        Draw.line(358, 20, 355, 50)